    ...
    try {
      ...
      if (success) {
        toast({
          ...
          description: "Welcome to ShopEasy! Your account has been created successfully.",
        })
        router.push("/")
      } else {
        toast({
    ...
    <div className="container mx-auto flex min-h-[calc(100vh-200px)] flex-col items-center justify-center px-4 py-12">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center">
          ...
          <p className="mt-2 text-muted-foreground">Sign up to get started with ShopEasy</p>
        </div>
